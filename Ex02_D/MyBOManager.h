...
public:
	...
	*/
	...
	-- will display Objects in white and colliding ones in red, if the value is vector3(-2.0f,-2.0f,-2.0f)
	-- it will display in red only the colliding ones
	OUTPUT: ---
	*/
	...
	*/
	...
	/*
	USAGE: Checks if there is a collision between these 2 objects and markes it in their lists
	ARGUMENTS:
	...
	*/
	...
	/*
	USAGE: Marks a collision in the designated BO
	ARGUMENTS: 
	- uint a_nIndexA -> Index of the first object
	- uint a_nIndexB -> Index of the second object
	OUTPUT: ---
	*/
	void MarkCollisionInList(uint a_nIndexA, uint a_nIndexB);
	/*
	USAGE: Clears the Colliding list of all BOs
	ARGUMENTS: ---
	OUTPUT: ---
	*/
	void ClearCollidingLists(void);
	/*
