...
#pragma region ON PRESS/RELEASE DEFINITION
	static bool	bLastF1 = false, bLastF2 = false, bLastF3 = false, bLastF4 = false, bLastF5 = false,
				...
				bLastO = false, bLastP = false, bLastG = false, bLastH = false, bLastJ = false,
				bLastK = false;
...
#pragma region Other Actions
	...
	bool bP = false;
	ON_KEY_PRESS_RELEASE(P, NULL, bP = true;)
	if (bP)
	{
		String sInstance = "Cube_" + std::to_string(m_pMeshMngr->GetInstanceCount());
